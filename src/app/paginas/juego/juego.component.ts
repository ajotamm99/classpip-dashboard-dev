...
export class JuegoComponent implements OnInit {
  ...
  objetosEscenasCreadas: ObjetoActivo[]=[];
  ...
  preguntasObjetosCreadas: PreguntaActiva[]=[];
              ...
              for(let b=0; b<this.escenasActivasRecibidas.length; b++){
                ...
                .subscribe((res)=>{
                  ...
                  for(let c=0; c<objapi.length; c++){
                    ...
                    obj.juegoDeEscaperoomId=juegoId;
                    obj.EnMochila=false;
                    obj.Usado=false;
                    ...
                    .subscribe(res=>{
                      ...
                      if(preguntasActivas.length>0){
                        ...
                        for(let d=0; d<preguntasActivas2.length; d++){
                          ...
                          preg.juegoDeEscaperoomId= juegoId2;
